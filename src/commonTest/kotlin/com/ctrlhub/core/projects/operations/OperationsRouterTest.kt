...
class OperationsRouterTest {
    ...
    fun `can retrieve all operations for work order`() {
        val jsonFilePath = Paths.get("src/commonTest/resources/projects/operations/all-operations-response.json")
    ...
    fun `can retrieve a single operation`() {
        val jsonFilePath = Paths.get("src/commonTest/resources/projects/operations/one-operation-response.json")
        val jsonContent = Files.readString(jsonFilePath)
    ...
    fun `can retrieve all operations with included templates`() {
        val jsonFilePath = Paths.get("src/commonTest/resources/projects/operations/all-operations-with-included-templates.json")
        val jsonContent = Files.readString(jsonFilePath)
