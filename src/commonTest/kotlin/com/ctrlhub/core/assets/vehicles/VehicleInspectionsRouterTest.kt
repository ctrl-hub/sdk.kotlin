...
class VehicleInspectionsRouterTest {
    ...
    fun `can retrieve all vehicle inspections`() {
        val jsonFilePath = Paths.get("src/commonTest/resources/assets/vehicles/all-vehicle-inspections-response.json")
    ...
    fun `can retrieve one vehicle inspection`() {
        val jsonFilePath = Paths.get("src/commonTest/resources/assets/vehicles/one-vehicle-inspection-response.json")
        val jsonContent = Files.readString(jsonFilePath)
