...
class OperationTemplatesRouterTest {
    ...
    fun `can retrieve all operation templates`() {
        val jsonFilePath = Paths.get("src/test/resources/projects/operations/templates/all-operation-templates-response.json")
    ...
    fun `can retrieve a single operation template`() {
        val jsonFilePath = Paths.get("src/test/resources/projects/operations/templates/one-operation-template-response.json")
        val jsonContent = Files.readString(jsonFilePath)
